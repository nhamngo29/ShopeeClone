    ...
    <div className='rounded-sm bg-white px pb-10 md:px-7 md:pb-20 shadow'>
      ...
      <div className='mt-6 flex flex-wrap flex-col sm:flex-row'>
        ...
        <div className='sm:w-[80%] sm:pl-5'>
          <InputPassword classNameInput='px-1 py-2 w-full outline-none border border-gray-300 focus:border-gray-500 rounded-sm focus:shadow-sm'
      ...
      <div className='mt-6 flex flex-wrap flex-col sm:flex-row'>
          <div className='sm:w-[20%] truncate pt-3 sm:text-right'>Nhập lại mật khẩu</div>
          <div className='sm:w-[80%] sm:pl-5'>
            <InputPassword classNameInput='px-1 py-2 w-full outline-none border border-gray-300 focus:border-gray-500 rounded-sm focus:shadow-sm'
