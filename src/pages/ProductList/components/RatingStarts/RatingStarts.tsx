      ...
      {Array(5)
        ...
        .map((_, index) => (
          <li className='py-1 pl-2' key={index}>
            <button className='flex items-center text-sm' onClick={() => handleFilterStart(5 - index)}>
              {Array(5)
                .fill(0)
                .map((_, indexStart) => {
                  if (indexStart < 5 - index) {
                    return (
                      <svg viewBox='0 0 9.5 8' key={indexStart} className='w-4 h-4 mr-1'>
                        <defs>
                    ...
                    return (
                      <svg key={indexStart} viewBox='0 0 30 30' className='w-4 h-4 mr-1'>
                        <defs>
