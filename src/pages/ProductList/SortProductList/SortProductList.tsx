    ...
    <div className='bg-gray-300/40 px-3 py-3'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex items-center flex-wrap gap-2'>
          ...
          <button className='h-8 px-4 capitalize bg-orange text-white text-sm rounded-sm'>Phổ biến</button>
          <button className='h-8 px-4 capitalize bg-white text-black text-sm rounded-sm'>Mới nhất</button>
          <button className='h-8 px-4 capitalize bg-white text-black text-sm rounded-sm'>Bán chạy</button>
          <select
